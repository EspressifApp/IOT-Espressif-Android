...
public class WelcomeActivity extends Activity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        int currentVersion = EspApplication.sharedInstance().getVersionCode();
    ...
    private View.OnClickListener mToLoginListener = new View.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            int versionCode = EspApplication.sharedInstance().getVersionCode();
    ...
    private void login()
    {
        ...
        if (user.isAutoLogin())
        {
            ...
            Intent autoIntent = new Intent(this, EspUIActivity.class);
