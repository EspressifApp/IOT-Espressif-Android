...
public class EspCommandEspButtonConfigureOld implements IEspCommandEspButtonConfigure
{
    private static final Logger log = Logger.getLogger(EspCommandEspButtonConfigureOld.class);
