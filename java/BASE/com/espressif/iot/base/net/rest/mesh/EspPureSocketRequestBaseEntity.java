...
public class EspPureSocketRequestBaseEntity implements IEspSocketRequest
{
    ...
    public EspPureSocketRequestBaseEntity(String method, String uriStr, String content)
    {
        this.mMethod = method;
    ...
    public EspPureSocketRequestBaseEntity(String method, String uriStr)
    {
     ...
     *  "path": "/v1/device/",
     *  "method": "GET",
     *  "meta": { "Authorization": "token 000..." },
     *  "get": {"a"=1,"b"=2},
     *  "post": {"commandKey":"commandValue"},
     *  }\r\n
     */
    @Override
    ...
    public static void main(String args[])
    {
        ...
        try
        {
            ...
            EspPureSocketRequestBaseEntity baseEntity = new EspPureSocketRequestBaseEntity(method, uriStr, content);
