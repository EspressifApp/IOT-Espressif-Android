...
import com.espressif.iot.object.db.IGroupRemoveDeviceDB;

// KEEP INCLUDES END
/**
 * Entity mapped to table GROUP_REMOVE_DEVICE_DB.
 */
public class GroupRemoveDeviceDB implements IGroupRemoveDeviceDB {
    ...
    private transient GroupRemoveDeviceDBDao myDao;
    ...
    public GroupRemoveDeviceDB() {
    }

    public GroupRemoveDeviceDB(Long id) {
        this.id = id;
    }

    public GroupRemoveDeviceDB(Long id, long groupId, String bssid) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getGroupRemoveDeviceDBDao() : null;
    }
