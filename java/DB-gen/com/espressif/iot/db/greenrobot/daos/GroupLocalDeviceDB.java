...
// KEEP INCLUDES END
/**
 * Entity mapped to table GROUP_LOCAL_DEVICE_DB.
 */
public class GroupLocalDeviceDB implements IGroupLocalDeviceDB {
    ...
    private transient GroupLocalDeviceDBDao myDao;
    ...
    public GroupLocalDeviceDB(Long id) {
        this.id = id;
    }

    public GroupLocalDeviceDB(Long id, long groupId, String bssid) {
        this.id = id;
    ...
    public void __setDaoSession(DaoSession daoSession) {
        ...
        myDao = daoSession != null ? daoSession.getGroupLocalDeviceDBDao() : null;
    }
