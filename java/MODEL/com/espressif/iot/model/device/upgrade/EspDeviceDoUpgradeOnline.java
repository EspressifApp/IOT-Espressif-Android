...
public class EspDeviceDoUpgradeOnline implements IEspDeviceDoUpgradeOnline
{
    private final static Logger log = Logger.getLogger(EspDeviceDoUpgradeOnline.class);
