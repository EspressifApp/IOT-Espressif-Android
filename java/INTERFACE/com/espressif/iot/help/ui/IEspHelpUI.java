...
{
    static final int RESULT_EXIT_HELP_MODE = 9;
    ...
    static final int RESULT_HELP_USE_LIGHT = 101;
    
    static final int RESULT_HELP_USE_HUMITURE = 102;
    
    static final int RESULT_HELP_USE_FLAMMABLE = 103;
    
    static final int RESULT_HELP_USE_REMOTE = 104;
    
    static final int RESULT_HELP_USE_VOLTAGE = 105;
