...
public class InitLogger {
    public static void init(){
        ...
        Logger.getLogger(com.espressif.iot.base.net.rest2.EspMeshUpgradeServer.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.action.device.common.upgrade.EspActionDeviceUpgradeOnline.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.model.device.statemachine.EspDeviceStateMachineExecutor.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.action.longsocket2.EspActionLongSocket.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.action.device.common.upgrade.EspActionDeviceUpgradeLocal.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.action.device.common.EspActionDeviceConfigureLocal.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.model.group.EspGroupHandler.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.model.device.EspDeviceConfigure.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.model.device.cache.EspDeviceCacheHandler.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.model.device.statemachine.EspDeviceStateMachineHandler.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.model.device.EspDeviceRoot.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.command.device.remote.EspCommandRemotePostStatusInternet.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.action.device.common.upgrade.EspDeviceCheckCompatibility.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.ui.device.trigger.DeviceTriggerActivity.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.esppush.EspPushService.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.ui.main.EspUIActivity.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.ui.device.trigger.EspTriggerSettingsFragment.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.command.device.espbutton.EspCommandEspButtonConfigure.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.ui.login.LoginThirdPartyDialog.class).setLevel(Level.OFF);
        Logger.getLogger(com.espressif.iot.ui.configure.DeviceBrowserWebFragment.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.base.net.proxy.MeshLog.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.base.net.rest2.EspMeshDiscoverUtil.class).setLevel(Level.OFF);
        ...
        Logger.getLogger(com.espressif.iot.base.net.rest2.EspHttpDownloadUtil.class).setLevel(Level.OFF);
    }
}